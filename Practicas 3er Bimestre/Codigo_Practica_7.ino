 ...
 * Nombre: Luis Andres Muñiz
 * Carnet: 2019127
 * Nombre: Cristian Estuardo Orellana
 * Carnet: 2022030
 * Proyecto: EGGSA
*/
//Librerias
...
//Directivas
#define rst  9    //Pin 9 para el reset del RC522
#define ss  10   //Pin 10 para el SS (SDA) del RC522
#define pVoltaje A0   //Pin Sensor de voltaje
#define pCorriente A7 //Pin sensor de corriente
...
//Constructores
MFRC522 mfrc522(ss, rst); ///Creamos el objeto para el RC522
DS3231 Clock;
LiquidCrystal_I2C PANTALLA_MEDIDOR(direccion, columnas, filas);
...
void setup() {
  ...
  pinMode(pVoltaje, INPUT);
  pinMode(pCorriente, INPUT);
...
//  Voltaje
  ...
  float voltaje =  (float)25*analogRead(pVoltaje)/1023;
...
//  Corriente
  ...
  float med = analogRead(pCorriente)*(5.0/1023.0);
